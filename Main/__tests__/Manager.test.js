...
// Testing that you can correctly set, the office number property, of a manager instance:  
  it('Should set office number via constructor arguments', () =>{
    const testValue = 415;
    const newMngr = new Manager('Pollux', 5, 'jane@gmail.com', testValue);
    expect(newMngr.managerOfficeNumber).toEqual(testValue);
  });
...
it('Should getRole() and return `Manager`', () => {
    ...
    const newMngr = new Manager('Pollux', 5, 'jane@gmail.com', 415);
